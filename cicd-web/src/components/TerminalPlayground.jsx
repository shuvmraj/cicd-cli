        ...
        <div className="macbook-3d-canvas-container" style={{ width: '100%', maxWidth: '1000px', height: '620px', position: 'relative' }}>
          ...
          <Canvas camera={{ position: [0, 0.38, 1.6], fov: 38 }}>
            ...
            <Suspense fallback={null}>
              {/* MacBook placed in a completely fixed, centered, static 3D position */}
              <group position={[0, -0.4, 0]} rotation={[0.05, 0, 0]} scale={1.28}>
                <Macbook3D>
                  {/* macOS Screen contents - Always visible, stationary, non-moving */}
                  <div 
